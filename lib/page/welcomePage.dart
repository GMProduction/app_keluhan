...
class _WelcomePageState extends State<WelcomePage> {
    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          body:
          "Laporkan keluhanmu tentang kampus ini",
          image: _buildImage('images/images.png'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Pemrosesan Keluhan",
          body:
          "Keluhanmu akan segera di proses oleh kampus",
          image: _buildImage('images/pengerjaan.png'),
          decoration: pageDecoration,
        ),
        // PageViewModel(
  ...
  void login() async {
    // var dataLogin = await req.postApi("keluhan");
